...
std::shared_ptr<RunTimeVal> Interpreter::evaluateTryStatement(std::shared_ptr<TryStatement> statement) {};
std::shared_ptr<RunTimeVal> Interpreter::evaluateFuncDecl(std::shared_ptr<FunctionDecleration> statement) {};
std::shared_ptr<RunTimeVal> Interpreter::evaluateThrow(std::shared_ptr<ThrowStatement> statement) {};
